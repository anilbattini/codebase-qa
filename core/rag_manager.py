...
class RagManager:
    ...
    def build_rag_index(self, project_dir, ollama_model, ollama_endpoint, project_type, log_placeholder, incremental=False, files_to_process=None):
        ...
        with st.spinner("🔄 Building RAG index..."):
            try:
                log_to_sublog(project_dir, "rag_manager.log", f"Starting RAG index build with provider: {model_config.get_current_provider_type()}")
                ...
                log_to_sublog(project_dir, "rag_manager.log", f"RAG index build failed: {e}")
